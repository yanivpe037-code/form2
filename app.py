...
def google_tasks_url():
    ...
    return jsonify({
        ...
        'daily_tasks': [
            '💧 לשתות 8 כוסות מים',
            '🥗 לאכול 5 מנות פירות וירקות',
            '🚫 לא לגעת במתוקים — יום שלם!',
            '🚫 לא לאכול שאריות של הילדים',
            '🚫 לא לקחת חטיפים מהעבודה',
            '🍎 לקחת פרי לעבודה',
            '🥬 לחתוך ירקות לנשנוש',
            '🫖 לשתות 2 כוסות תה בלי סוכר',
            '📊 לעדכן את דשבורד הבריאות בערב',
            '⚖️ לשקול את עצמך בבוקר',
        ],
        'weekly_tasks': [
            '🛒 קניות שבועיות — פירות, ירקות, חלבונים',
            '🔪 הכנת ירקות חתוכים לשבוע',
            '🍳 הכנת ארוחות מראש (Meal Prep)',
            '🗑️ לזרוק כל חטיף/ממתק שנשאר בבית',
            '📸 לצלם תמונת התקדמות',
            '📏 למדוד היקף מותניים',
            '📋 לתכנן תפריט שבועי',
            '🛒 לבדוק שיש: שקדים, אגוזים, חומוס, טחינה',
            '🧹 לנקות את המקרר מאוכל לא בריא',
            '📵 למחוק אפליקציות משלוחי אוכל',
        ],
        'monthly_tasks': [
            '🩺 בדיקת דם — סוכר, כולסטרול, לחץ דם',
            '👖 לנסות את הג\'ינס הצר',
            '📸 תמונת לפני/אחרי חודשית',
            '🎯 לעדכן יעדי משקל',
            '👔 ללכת לקנות בגד חדש במידה קטנה יותר',
        ]
    })
...
def keep_note_url():
    ...
    import random
    daily_inspirations = [
        'אתה כבר עשית את זה פעם — אתה יכול שוב!',
        'כל יום נקי מקרב אותך לגוף שתמיד רצית',
        'הילדים שלך צריכים אבא בריא. תהיה שם בשבילם.',
        'תדמיין את עצמך נכנס לג\'ינס הצר. זה אפשרי!',
        'אתה חזק יותר מכל חטיף. הוכח את זה היום.',
        'כמה נעים לקנות בגדים כשאתה רזה? תחזור לשם!',
        'סוכר = רעל. בגיל 40 אין סיכוי שני. תשמור על עצמך.',
        'מים, ירקות, פירות, חלבון. זה כל מה שאתה צריך.',
        'שאריות של הילדים? אתה לא פח זבל!',
        'שטויות מהעבודה לא תורמות לבריאות. תגיד לא!',
        'תכנון = הצלחה. מי שמתכנן — מצליח. מי שלא — אוכל שטויות.',
        '30 שניות בפה, שבוע על הבטן. שווה?',
        'כל פעם שאתה אומר לא לחטיף — אתה מנצח!',
        'מחר מתחיל היום. עכשיו!',
        'הגוף שלך הוא הנכס הכי יקר שיש לך. תשקיע בו!',
    ]
    return jsonify({
        ...
        'notes': [
            {
                ...
                'items': [
                    '--- פירות ---',
                    'תפוחים (6)', 'בננות (6)', 'קלמנטינות (1 ק"ג)', 'תותים',
                    'אוכמניות', 'אגסים', 'ענבים',
                    '--- ירקות ---',
                    'מלפפונים (6)', 'עגבניות (1 ק"ג)', 'גזר (חבילה)', 'פלפלים (4)',
                    'ברוקולי', 'כרובית', 'חסה/תרד (2)', 'בצל', 'שום',
                    'אבוקדו (3)', 'לימון',
                    '--- חלבונים ---',
                    'חזה עוף (1 ק"ג)', 'סלמון/דג (500 גרם)', 'ביצים (30)',
                    'טונה קופסאות (4)', 'גבינת קוטג\' (3)',
                    '--- נשנושים בריאים ---',
                    'שקדים (200 גרם)', 'אגוזי מלך', 'חומוס', 'טחינה',
                    '--- שתייה ---',
                    'תה ירוק', 'תה נענע', 'לימון לתה',
                ]
            },
            {
                'title': '🚨 10 כללי ברזל — קרא כל יום!',
                'color': 'RED',
                'items': [
                    '1. לא אוכל שאריות של הילדים — אני לא פח!',
                    '2. לא לוקח חטיפים מהעבודה — אפילו לא "חתיכה קטנה"',
                    '3. שותה כוס מים לפני כל ארוחה',
                    '4. ירקות חתוכים תמיד מוכנים במקרר',
                    '5. לא קונה מתוקים לבית — בכלל!',
                    '6. אין אוכל אחרי 8 בערב — מטבח סגור!',
                    '7. כל ארוחה — חצי צלחת ירקות',
                    '8. פרי במקום קינוח. תמיד.',
                    '9. לא מזמין משלוחי אוכל — אני מבשל בריא!',
                    '10. 8 כוסות מים ביום — בלי פשרות!',
                ]
            },
            {
                'title': '📋 תפריט יומי לדוגמה',
                'color': 'YELLOW',
                'items': [
                    '🌅 בוקר: 2 ביצים + סלט ירקות + פרי',
                    '☕ ביניים: תפוח + 10 שקדים',
                    '🥗 צהריים: חזה עוף/דג + סלט גדול + אורז מלא (מעט)',
                    '🫖 ביניים: תה ירוק + ירקות חתוכים',
                    '🌙 ערב: סלט טונה/ביצים + ירקות',
                    '💧 לאורך כל היום: מים מים מים!',
                ]
            },
            {
                'title': '💪 השראה יומית',
                'color': 'BLUE',
                'items': random.sample(daily_inspirations, min(5, len(daily_inspirations)))
            },
            {
                'title': '⚠️ מה סוכר עושה לגבר בן 40',
                'color': 'RED',
                'items': [
                    'מעלה סיכון לסוכרת סוג 2',
                    'מעלה כולסטרול ולחץ דם',
                    'גורם לדלקות כרוניות בגוף',
                    'מזרז הזדקנות של העור והגוף',
                    'פוגע בריכוז ובזיכרון',
                    'גורם לעייפות כרונית',
                    'מעלה סיכון למחלות לב',
                    'גורם לשומן בטני — הכי מסוכן!',
                    'ממכר כמו סם — ככל שאוכלים יותר, רוצים יותר',
                    'פוגע באיכות השינה',
                ]
            },
            {
                ...
                'color': 'GREEN',
                'items': [
                    'בגדים חדשים במידה קטנה!',
                    'אנרגיה לשחק עם הילדים',
                    'שינה טובה יותר',
                    'ביטחון עצמי גבוה',
                    'מחמאות מכולם',
                    'בדיקות דם תקינות',
